...
t_bool	ps_ss(t_stack_node **stack_a, t_stack_node **stack_b, t_bool should_print);

t_bool	ps_pa(t_stack_node **stack_a, t_stack_node **stack_b, t_bool should_print);
t_bool	ps_pb(t_stack_node **stack_b, t_stack_node **stack_a, t_bool should_print);

t_bool	ps_ra(t_stack_node **stack_a, t_bool should_print);
t_bool	ps_rb(t_stack_node **stack_b, t_bool should_print);
t_bool	ps_rr(t_stack_node **stack_a, t_stack_node **stack_b, t_bool should_print);

t_bool	ps_rra(t_stack_node **stack_a, t_bool should_print);
t_bool	ps_rrb(t_stack_node **stack_b, t_bool should_print);
t_bool	ps_rrr(t_stack_node **stack_a, t_stack_node **stack_b, t_bool should_print);
